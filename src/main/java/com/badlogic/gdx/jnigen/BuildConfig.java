...
public class BuildConfig {
	...
	public final com.badlogic.gdx.jnigen.FileDescriptor buildDir;
	/** the directory to put the shared libraries and natives jar file in **/
	public final com.badlogic.gdx.jnigen.FileDescriptor libsDir;
	/** the directory containing the native code **/
	public final com.badlogic.gdx.jnigen.FileDescriptor jniDir;
	...
	public BuildConfig (String sharedLibName) {
		...
		this.buildDir = new com.badlogic.gdx.jnigen.FileDescriptor("target");
		this.libsDir = new com.badlogic.gdx.jnigen.FileDescriptor("libs");
		this.jniDir = new com.badlogic.gdx.jnigen.FileDescriptor("jni");
	}
	...
	public BuildConfig (String sharedLibName, String temporaryDir, String libsDir, String jniDir) {
		this.sharedLibName = sharedLibName;
		this.buildDir = new com.badlogic.gdx.jnigen.FileDescriptor(temporaryDir);
		this.libsDir = new com.badlogic.gdx.jnigen.FileDescriptor(libsDir);
